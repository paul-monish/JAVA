package Assignment3;
/*
B. In general an equation of the form 𝑎𝑥^2 + 𝑏𝑥 + 𝑐 = 0 is known as a quadratic equation. Accept the
values of a, b, and c from the user and write a java program to calculate the roots of the given
quadratic equation.
 */
