package Assignment6;
/*
B. Write a java program to store 6 sorted (ascending order) elements in an array P, and 4 sorted
(ascending order)elements in an array Q and produce a third array R (without any sorting technique) ,
containing all the elements of array P and Q in sorted order. Display the resultant array.
 */
