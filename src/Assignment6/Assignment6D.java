package Assignment6;
/*
D. Write a menu driven java program to search an element from list on n numbers using following searching
techniques: (a) Linear Search (b) Binary Search (Non recursive)
 */
...
public class Assignment6D {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		int ch;
		do {
			System.out.println("1.Linear Assignment6.Search\n2.Binary Assignment6.Search\n3.Exit");
